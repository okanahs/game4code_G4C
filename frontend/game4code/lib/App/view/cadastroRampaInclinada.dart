...
import 'package:game4code/App/custom/aceleracao_icon_icons.dart';
import 'package:game4code/App/custom/app_icons.dart';
import 'package:game4code/App/drawer/drawer.dart';

class CadastroRampaInclinada extends StatelessWidget {
  @override
...
class CadastroRampaInclinadaProf extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
