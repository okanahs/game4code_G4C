...
Future<User> logUser(String email, String senha) async {
  final response = await http.post(
    ...
    body: jsonEncode(
        <String, String>{'email': email, 'senha': senha}),
  );
...
class User {
  ...
  const User({required this.email, required this.senha});

  factory User.fromJson(Map<String, dynamic> json) {
    return User(email: json['email'], senha: json['senha']);
  }
}
